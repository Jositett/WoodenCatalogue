...
const About: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-[#F7F3E9]">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h2 className="font-playfair text-3xl md:text-4xl text-[#5C4033] mb-6">
            ...
            <div className="flex space-x-4">
              <Link href="/catalogue">
                <Button className="bg-[#7D5A50] hover:bg-[#5C4033] text-white">
                  Explore Our Collection
                </Button>
              </Link>
              <Link href="/#contact">
                <Button variant="outline" className="border-[#7D5A50] text-[#7D5A50] hover:bg-[#7D5A50] hover:text-white">
                  Contact Us
                </Button>
              </Link>
            </div>
